...
?>
        ...
        <li><div class="image-test wow fadeInLeft" data-wow-delay="0s">
        <?php  if($authpic!=''){ ?>
         <img src="<?php echo $authpic; ?>">
         <?php } ?>
        </div>
        <div class="test-cont-heading"><h2><?php echo apply_filters('widget_title', $title ); ?></h2></div>
        <div class="test-cont wow fadeInRight" data-wow-delay="0s"><a href="<?php echo $link; ?>"><p><?php echo $text; ?></p></a><p><?php echo $desc; ?></p></div>
        </li>
